...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="todo__task todo__input--edit todo__input";
    ...
    deleteButtonImg.className="todo__img--delete";
    deleteButtonImg.alt ='btn-remove-image';
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".todo__btn.todo__btn--edit");
    var deleteButton=taskListItem.querySelector(".todo__btn.todo__btn--delete");
